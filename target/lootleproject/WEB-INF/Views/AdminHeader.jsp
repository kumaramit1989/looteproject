    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-shopping-cart"></span> Manage Orders <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="Product"><span class="glyphicon glyphicon-shopping-cart"></span> New order</a></li>
          <li><a href="Product"><span class="glyphicon glyphicon-shopping-cart"></span> Shipments</a></li>
          <li><a href="Product"><span class="glyphicon glyphicon-list"></span> Invoice</a></li>
        </ul>
      </li>
        ...
        <ul class="dropdown-menu">
        <li><a href="Category"><span class="glyphicon glyphicon-plus"></span> Add category</a></li>
          <li><a href="Product"><span class="glyphicon glyphicon-plus"></span> Add Products</a></li>
          <li><a href="Product"><span class="glyphicon glyphicon-trash"></span> Remove Products</a></li>
          <li><a href="Product"><span class="glyphicon glyphicon-edit"></span> Update Products</a></li>
        </ul>
      </li>
       <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"></span>Manage Users <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="Product"><span class="glyphicon glyphicon-plus"></span> Add User</a></li>
          <li><a href="Product"><span class="glyphicon glyphicon-trash"></span> Remove User</a></li>
       ...
       <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"></span> Manage Supplier<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="Product"><span class="glyphicon glyphicon-plus"></span> Add Supplier</a></li>
          <li><a href="Product"><span class="glyphicon glyphicon-trash"></span> Remove Supplier</a></li>
