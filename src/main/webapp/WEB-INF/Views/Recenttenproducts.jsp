		...
		<div class="row centered-form">
			<div ng-repeat="product in products|filter:seachproduct">
				<div class="col-xs-4">
					<div class="item">
						<div class="thumbnail">
						<a href="fetchproducttodisplay?prodid={{product.productId}}"><img src="./resources/productimage/{{product.productId}}.jpg" height="150px" width="150px" /></a>
							<div class="caption">
